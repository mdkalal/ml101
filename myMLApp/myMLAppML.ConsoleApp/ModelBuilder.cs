...
namespace MyMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\dev\projects\myMLApp\wikipedia-detox-250-line-data.tsv";
        //private static string TRAIN_DATA_FILEPATH = @"C:\dev\projects\myMLApp\train_full.tsv";
        private static string MODEL_FILEPATH = @"../../../../MyMLAppML.Model/MLModelz.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 5E-07f, ConvergenceTolerance = 0.01f, NumberOfIterations = 10, Shuffle = true, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
